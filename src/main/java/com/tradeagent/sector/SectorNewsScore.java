...
@Entity
@Table(
        name = "sector_news_score",
        uniqueConstraints = {
                @UniqueConstraint(name = "uk_sector_news_score_code_date", columnNames = {"sector_code", "score_date"})
        },
        indexes = {
...
public class SectorNewsScore extends BaseEntity {
    ...
    protected SectorNewsScore() {
    }

    public SectorNewsScore(String sectorCode, LocalDate scoreDate, Integer articleCount, BigDecimal avgToneScore,
    ...
    public void update(Integer articleCount, BigDecimal avgToneScore, BigDecimal newsVolumeScore,
